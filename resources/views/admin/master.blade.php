...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('adminAssets/plugins/iCheck/flat/blue.css') }}">
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{ asset('adminAssets/plugins/morris/morris.css') }}">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{ asset('adminAssets/plugins/jvectormap/jquery-jvectormap-1.2.2.css') }}">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ asset('adminAssets/plugins/datepicker/datepicker3.css') }}">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ asset('adminAssets/plugins/daterangepicker/daterangepicker-bs3.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('adminAssets/dist/css/custom-style.css') }}">
...
<!-- Sparkline -->
<script src="{{ asset('adminAssets/plugins/sparkline/jquery.sparkline.min.js') }}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{ asset('adminAssets/plugins/knob/jquery.knob.js') }}"></script>
<!-- daterangepicker -->
